...
//Light 2
const pointLight2 = new THREE.PointLight('red', 0.2)
...
const pointLight3 = new THREE.PointLight(0xf0f0, 0.2)
pointLight3.position.set(1,-0.52,-0.33)
...
const tick = () =>
{
    ...
    sphere.rotation.y += .8 * (targetX - sphere.rotation.y)
    sphere.rotation.x += .8 * (targetY - sphere.rotation.x)
